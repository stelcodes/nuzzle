...
;; This namespace is derived from Rum's rum.server-render namespace
;; All credit to Nikita Prokopov and the other Rum contributors
...
(defn render-attr! [tag key value sb]
  (let [attr (normalize-attr-key key)]
    (cond
      ...
      ;; Nuzzle addition
      (and (= "href" attr) (vector? value)) (render-attr-str! sb attr (util/stringify-url value))
...
(extend-protocol HtmlRenderer
  ...
  Object
  (-render-html [this sb]
    (-render-html (str this) sb))

  nil
  (-render-html [_this _sb]
    :nop))
