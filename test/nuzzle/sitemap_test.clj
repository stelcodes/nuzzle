...
(deftest create-sitemap
  ...
  (is (= (-> "test-resources/xml/config-1-sitemap.xml" slurp str/trim)
         (sitemap/create-sitemap (config) (gen/create-site-index (config)))))
...
(comment (spit "test-resources/xml/config-1-sitemap.xml" (sitemap/create-sitemap (config) (gen/create-site-index (config)))))
